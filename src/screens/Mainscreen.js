                    ...
                    <View  style={styles.box}>
                        <View style={{marginLeft:60, marginTop:40}}>
                            <TouchableOpacity onPress={() => navigation.navigate("Sleep")}>
                                ...
                                <Text style={{fontSize:20, marginLeft:5, marginTop:8, color:'#AEAEAE'}}>취침</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{position:'absolute', marginLeft : 230, marginTop : 40}}>
                            <TouchableOpacity onPress={() => navigation.navigate("Call")}>
                                <Image source={require('../images/phone.png')} />
                                <Text style={{fontSize:20, marginLeft:5, marginTop:8, color:'#AEAEAE'}}>상담</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft:60, marginTop : 90}}>
                            <TouchableOpacity onPress={() => navigation.navigate("Camera")}>
                                <Image source={require('../images/camera.png')} />
                                <Text style={{fontSize:20, marginTop:8, color:'#AEAEAE'}}>카메라</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{position:'absolute', marginLeft:230, marginTop:185}}>
                            <TouchableOpacity  onPress={() => navigation.navigate("Speak")}>
                                ...
                                <Text style={{fontSize:20, marginLeft:5, marginTop:8, color:'#AEAEAE'}}>음성</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{marginLeft:60, marginTop:90}}>
                            <TouchableOpacity  onPress={() => navigation.navigate("Setting")}>
                                <Image source={require('../images/setting.png')} />
                                <Text style={{fontSize:20, marginLeft:0, marginTop:8, color:'#AEAEAE'}}>설정</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={{position:'absolute', marginLeft:230, marginTop : 340}}>
                            <TouchableOpacity>
                                <Image source={require('../images/bell.png')} />
                                <Text style={{fontSize:20, marginLeft:0, marginTop:8, color:'#AEAEAE'}}>알림</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
